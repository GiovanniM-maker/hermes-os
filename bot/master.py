...
_KEYWORD_ROUTES: list[tuple[list[str], str]] = [
    ...
    (["pipeline", "workflow n8n", "crea workflow", "automazione", "pipelineforge"],
     "pipeline_request"),
    # Calendario → TaskBot (deve stare PRIMA di task generico)
    (["calendario", "agenda", "impegni", "impegno", "appuntament",
      "riunione", "meeting", "call domani", "call alle",
      "cosa ho domani", "cosa ho oggi", "programma domani", "programma settimana",
      "sono libero", "slot liberi", "quando sono libero",
      "metti un", "fissa un", "segna un", "prenota",
      "domani alle", "lunedi", "martedi", "mercoledi", "giovedi", "venerdi",
      "questa settimana", "prossima settimana", "programma serale"],
     "task_mgmt"),
